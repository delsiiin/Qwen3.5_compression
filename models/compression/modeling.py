...
from transformers.models.qwen3_moe.modeling_qwen3_moe import (
    ...
    eager_attention_forward as qwen3_moe_eager_attention_forward,
...
KV_COMPRESSION_MAP = {
    ...
    "tridentkv": TridentKV,
    "tridentkv_head_cluster": TridentKVHeadCluster,
    "tridentkv_spatial_temporal": TridentKVSpatialTemporal,
    "tridentkv_spatial_temporal_ada": TridentKVSpatialTemporalAda,
...
def Qwen2_Attention_init(self, config: Qwen2Config, layer_idx: int, compression_config: dict):
    nn.Module.__init__(self)
